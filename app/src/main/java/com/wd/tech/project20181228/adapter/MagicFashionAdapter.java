...
public class MagicFashionAdapter extends RecyclerView.Adapter<MagicFashionAdapter.ViewHolder> {
    ...
    public MagicFashionAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.home_magicfashion_item,viewGroup,false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            draweeView = itemView.findViewById(R.id.home_magicfashion_image);
            text_name = itemView.findViewById(R.id.home_magicfashion_name);
            text_price = itemView.findViewById(R.id.home_magicfashion_price);
        }
    }
